...
Якщо в уривках виявлено граматичні чи фактичні (наприклад НаВКМА замість НаУКМА тощо) помилки та цю інформацію використано для відповіді, обов'язкововиправ їх у відповіді.
...
Надавай ім'я файлу лише в тому випадку, якщо користувач попросив тебе зробити це. 
Назва файлу не є номером наказу чи документа! Не надавай зайвої інформації. Не надавай неіснуючі дати, це заборонено!
Ігноруй та ні в якому разі не додавай у відповідь користувачеві незрозумілі символи та неточності, бо таке може бути в наданих уривках документів, отриманих за допомогою ocr. (наприклад <sup>2020</sup> замість дати, тощо, бо це артефакти ocr)."""
        
        context_text = "\n\n".join([
            f"документ {ctx['metadata']['filename']}):\n{ctx['text']}"
            for ctx in contexts
        ])
